...
TOKEN = os.getenv('8782761658:AAFUBiGfTtmAiz19D6BtbJ1_1zoDEXU4ToU')
OWNER_ID_STR = os.getenv('8782761658')
ADMIN_ID_STR = os.getenv('7167704900')
YOUR_USERNAME = os.getenv('@ZenoWebsReal')
UPDATE_CHANNEL = os.getenv('https://t.me/HappyBhaiBolta')
...
YOUR_USERNAME = YOUR_USERNAME or '@ZenoRealWebs'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/HappyBhaiBolta'
